...
export default function WebDev() {
    ...
    return (
        <section className="flex flex-col justify-center items-center min-h-screen min-w-screen  text-white py-60 sm:py-40 lg:py-50 px-4 sm:px-6 lg:px-8 border-solid" ref={elementRef}>
